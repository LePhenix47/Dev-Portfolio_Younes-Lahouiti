          ...
          <section className="about-page__text-cards-container">
            <div className="about-page__cards">
              <div className="about-page__card">
                <h3 className="about-page__card-title">Experience</h3>
                <p className="about-page__card-description">1 year</p>
              </div>
              <div className="about-page__card">
                <h3 className="about-page__card-title">Completed</h3>
                <p className="about-page__card-description">20+ Projects</p>
              </div>
              <div className="about-page__card">
                <h3 className="about-page__card-title">Support</h3>
                <p className="about-page__card-description">7/7 days</p>
              </div>
            </div>
            <div className="about-page__text">
              <p className="about-page__description">
                I&apos;m a full-stack developer with expertise in developing web
                applications, including the integration of UI/UX interface.
                While my primary focus is on developing the functionality of the
                applications, I am also proficient in integrating Figma mockups.
              </p>
              <Link
