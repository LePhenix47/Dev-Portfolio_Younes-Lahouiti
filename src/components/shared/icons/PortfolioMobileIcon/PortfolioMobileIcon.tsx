...
/**
 * PortfolioMobileIcon component used in the <header> when the user has a small viewport device.
 *
 ...
 *
 * @returns {JSX.Element} - The rendered PortfolioMobileIcon component.
 *
 * @component
 *
 * @example
 ...
 * @component
 */
export default function PortfolioMobileIcon({
  width,
  height,
  fill,
